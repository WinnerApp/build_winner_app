...
- [Fix] 修复无法在高版本的CLR进行出包的问题[兼容低版本]

## 3.4.4

- [Fix] 降低dart_appwrite版本从12.2.0到12.1.0 修复了查询报错

## 3.4.3

- [Fix] 修复了获取日志按照最大获取导致超出索引

## 3.4.2

- [Add] 修复了导出命令会让配置打包的参数

## 3.4.1

- [Fix] 修复了日志不显示Flutter和Unity的日志节点

## 3.4.0

- [Add] 新增了unity分支查询条件 
- [Fix] 修复了查询上一个节点为空获取日志不正确
